...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        private Texture2D AberrationLUT = new Texture2D(3, 1);
        ...
        CustomChromaticAberration m_CustomChromaticAberration;
        Vignette m_Vignette;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //@@@
            m_CustomChromaticAberration = stack.GetComponent<CustomChromaticAberration>();
        ...
        RenderTextureDescriptor GetCompatibleDescriptor()
            => GetCompatibleDescriptor(m_Descriptor.width, m_Descriptor.height, m_Descriptor.graphicsFormat, 0);
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            //@@@CustomChromaticAberration
            if (m_CustomChromaticAberration.IsActive() && !cameraData.isSceneViewCamera)
            {
                MaterialPropertyBlock m_MatBlock = new MaterialPropertyBlock();
                SetupCustomChromaticAberration(m_MatBlock);
                ...
                cmd.DrawMesh(RenderingUtils.fullscreenMesh, Matrix4x4.identity, m_Materials.CustomChromaticAberration, 0, 0, m_MatBlock);
        ...
        #endregion
        //@@@CustomChromaticAberration
        #region Custom Chromatic Aberration
        void SetupCustomChromaticAberration(MaterialPropertyBlock matBlock)
        {
            matBlock.SetTexture(Shader.PropertyToID("_AberrationLUT"), AberrationLUT);
            matBlock.SetFloat(Shader.PropertyToID("_Intensity"), m_CustomChromaticAberration.Intensity.value);
        }
        ...
        {
            public readonly Material CustomChromaticAberration;
            ...
            {
                CustomChromaticAberration = Load(data.shaders.ChromaticShader);
            ...
            {
                CoreUtils.Destroy(CustomChromaticAberration);
